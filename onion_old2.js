...
//   const dataURI = "data:image/jpeg;base64," + base64Image;
  ...
  nodeHtmlToImage({
    ...
    beforeScreenshot: async function (page) {
      ...
      // await page.exposeFunction("wrapSvgStr", wrapSvgText.toString().split('ction(t){')[1].split("n),h")[0]);
      ...
      await page.evaluate(async (_) => {
        ...
        const dat = await wrapSvgText({
          text: "FOXBOROUGH, MA—Sharing details about a recent conversation with the former New England field general, Patriots…",
          style: {
              fontSize: "50px",
              width: "2015px",
          }
